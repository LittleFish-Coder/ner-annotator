...
final StateProvider<Tag?> tagProvider = StateProvider((ref) => null);
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          const Header(),
          const Divider(),
          Expanded(child: textBody(context)),
        ],
      ),
...
Widget textBody(BuildContext context) {
  // String text = lorem(paragraphs: 30, words: 100);
  return SizedBox(
    ...
    child: SingleChildScrollView(
      ...
      child: SelectableText.rich(
        TextSpan(
          text: "fakeNews\n",
          children: <TextSpan>[for (int i = 0; i < fakeNews.length; i++) TextSpan(text: fakeNews[i])],
        ),
      ),
    )),
  );
